...
var _a, _GameEvent_Start, _GameEvent_End, _GameEvent_FrameUpdate, _GameEvent_GraphicsSet;
class GameEvent {
    constructor(type) {
    ...
    static get GraphicsSet() { return __classPrivateFieldGet(_a, _a, "f", _GameEvent_GraphicsSet); }
}
_a = GameEvent;
_GameEvent_Start = { value: new _a('start') };
_GameEvent_End = { value: new _a('end') };
_GameEvent_FrameUpdate = { value: new _a('frame update') };
_GameEvent_GraphicsSet = { value: new _a('graphics set') };
